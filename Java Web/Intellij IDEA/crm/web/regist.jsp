    ...
    <script type="text/javascript">
        function checkCode(){
            ...
            if (code.trim() == "") {
                ...
                $("#codeId").addClass("error");
                $("#codeId").html("登录名不能包含空格");
            } else if (code.length < 6) {
                $("#codeId").addClass("error");
                $("#codeId").html("登录名长度不能小于6");
            } else {
        ...
        function checkPassword() {
            ...
            if (password.trim() == "") {
                ...
                $("#passwordId").addClass("error");
                $("#passwordId").html("密码不能包含空格");
            } else if (password.length < 6) {
                $("#passwordId").addClass("error");
                $("#passwordId").html("密码长度不能小于6");
            } else {
...
<
<BODY>
<FORM id=form1 name=form1 method=post action="${ pageContext.request.contextPath }/user_regist.action" onsubmit="return checkForm()">
                                ...
                                <TD>
                                    <TABLE cellSpacing=0 cellPadding=2 border=0>
                                        ...
                                        <TR>
                                            ...
                                            <TD style="HEIGHT: 28px"><SPAN id="passwordId"
                                                                           style="FONT-WEIGHT: bold;"></SPAN></TD></TR>

                                        <TR>
                                            <TD style="HEIGHT: 28px">用户姓名：</TD>
                                            <TD style="HEIGHT: 28px"><INPUT id="user_name" style="WIDTH: 130px"
                                                                            type=text name="user_name" onblur="checkName()"></TD>
                                            <TD style="HEIGHT: 28px"><SPAN id="nameId"
                                                                           style="FONT-WEIGHT: bold;"></SPAN></TD></TR>

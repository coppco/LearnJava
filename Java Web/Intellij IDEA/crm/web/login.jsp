...
<META content="MSHTML 6.00.6000.16809" name=GENERATOR>
  ...
  <script type="text/javascript">
    function changeImage(obj) {
        obj.src = "${ pageContext.request.contextPath}/verification_code.action?time=" + Math.random();
    }
  </script>
            ...
            <TABLE cellSpacing=0 cellPadding=2 border=0>
              ...
              <TR>
                ...
                <TD style="HEIGHT: 28px"><INPUT id=txtcode 
                                                style="WIDTH: 130px" name="v_code"></TD>
                <TD style="HEIGHT: 28px"><img style="height: 20px" src="${ pageContext.request.contextPath}/verification_code" onclick="changeImage(this)"></TD></TR>
              <TR>

...
<head>
    ...
    <SCRIPT language=javascript>
        ...
        $(function () {
            $.post("${pageContext.request.contextPath}/customer_findAll.action", {"1":"1"},function (data) {
                $(data).each(function (index, obj) {
                    var cust_id = "${model.customer.cust_id}";

                    if (cust_id == obj.cust_id) {
                        $("#customerId").append("<option value='" + obj.cust_id + "' selected>" + this.cust_name + "</option>");
                    } else  {
                        $("#customerId").append("<option value='" + obj.cust_id + "'>" + this.cust_name + "</option>");
                    }
                });
            }, "json");
        });
                            ...
                            <TABLE cellSpacing=0 cellPadding=2 border=0>
                                ...
                                <TR>
                                    ...
                                    <TD><INPUT class=textbox id=sChannel2
                                               style="WIDTH: 80px" maxLength=50 name="lkm_name" value="${model.lkm_name}">
                                    </TD>
